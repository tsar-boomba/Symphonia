...
impl AVCDecoderConfigurationRecord {
    pub async fn read(buf: &[u8]) -> Result<Self> {
        ...
        let configuration_version = br.read_bits_leq32(8).await?;
        ...
        let avc_profile_indication = br.read_bits_leq32(8).await?;
        let _profile_compatibility = br.read_bits_leq32(8).await?;
        let avc_level_indication = br.read_bits_leq32(8).await?;
...
impl HEVCDecoderConfigurationRecord {
    pub async fn read(buf: &[u8]) -> Result<Self> {
        ...
        let _general_profile_space = br.read_bits_leq32(2).await?;
        let _general_tier_flag = br.read_bit().await?;
        let general_profile_idc = br.read_bits_leq32(5).await?;
        let _general_profile_compatibility_flags = br.read_bits_leq32(32).await?;
        let _general_constraint_indicator_flags = br.read_bits_leq64(48).await?;
        let general_level_idc = br.read_bits_leq32(8).await?;
...
impl DOVIDecoderConfigurationRecord {
    pub async fn read(buf: &[u8]) -> Result<Self> {
        ...
        let config = DOVIDecoderConfigurationRecord {
            dv_version_major: br.read_bits_leq32(8).await? as u8,
            dv_version_minor: br.read_bits_leq32(8).await? as u8,
            dv_profile: br.read_bits_leq32(7).await? as u8,
            dv_level: br.read_bits_leq32(6).await? as u8,
            rpu_present_flag: br.read_bool().await?,
            el_present_flag: br.read_bool().await?,
            bl_present_flag: br.read_bool().await?,
            dv_bl_signal_compatibility_id: br.read_bits_leq32(4).await? as u8,
        };
